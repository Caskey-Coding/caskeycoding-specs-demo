# ADR-001: Spec-Driven Development as the Default Process

**Status:** `accepted`
**Date:** 2026-04-16

> **Demo note.** In this public demo repository this ADR is named
> `ADR-001`. In the private `caskeycoding-specs` repo it is numbered
> `ADR-003` (it was the 3rd org-wide ADR written there). Content is
> identical. See [decision/README.md](./README.md).
...
4. For multi-week projects, use a spec package (see ADR-001 _spec package shapes_ in the private repo)
